...
if x_train.shape[0] != 60000 or y_train.shape[0] != 60000:
    raise ValueError("The Fashion MNIST training dataset didn't load correctly. Please check your data.")
if x_test.shape[0] != 10000 or y_test.shape[0] != 10000:
    raise ValueError("The Fashion MNIST test dataset didn't load correctly. Please check your data.")
...
'''
Federated DNN Model Accuracy: 0.7381
Federated DNN Model Error Rate: 0.2619
